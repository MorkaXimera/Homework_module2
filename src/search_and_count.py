...
def process_bank_search(data: list[dict] = [], search: str = "") -> list[dict] | str:
    """
...
def process_bank_operations(data: list[dict] = [], categories: list = []) -> dict | str:
    """
