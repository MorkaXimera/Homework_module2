...
def test_filter_by_state_executed(processing_coll: list, filtred_executed: list) -> None:
    assert filter_by_state(processing_coll) == filtred_executed


def test_filter_by_state_canceled(processing_coll: list, filtred_canceled: list) -> None:
...
def test_filter_by_state_unknown(processing_coll: list) -> None:
    assert filter_by_state(processing_coll, state="UNKNOWN") == "Список не содержит указанных данных"


def test_sort_by_date_reverse(processing_coll: list, sorted_by_date_reverse: list) -> None:
    assert sort_by_date(processing_coll) == sorted_by_date_reverse


def test_sort_by_date(processing_coll: list, sorted_by_date: list) -> None:
    assert sort_by_date(processing_coll, reverse=False) == sorted_by_date


def test_sort_by_date_same_date(processing_coll_same_date: list, sorted_by_date_same_date: list) -> None:
    assert sort_by_date(processing_coll_same_date) == sorted_by_date_same_date


def test_sort_by_date_incorrect_date(processing_coll_incorrect_date: list) -> None:
